    ...
    <div className="container" style={{ marginBottom: 70, marginTop: 70 }}>
      ...
      <div className="row row--grid">
        <div className="col-12 col-lg-7 col-xl-8">
          <form ref={form as any} className="sign__form sign__form--contacts">
            <div className="row">
              ...
              <div className="col-12 col-xl-3">
                <button type="button" className="sign__btn" onClick={submit}>
                  Send
                </button>
              </div>
            </div>
        ...
        <div className="col-12 col-md-6 col-lg-5 col-xl-4">
          <div className="main__title main__title--sidebar">
            <h2>Info</h2>
            <p>
              Should you require further assistance please use the contact us
              box
            </p>
          </div>
          ...
          <div className="contacts__social">
            <a href="https://www.facebook.com/BKSBackstage" target="_blank">
            ...
            <a href="https://twitter.com/BackstageBks" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="https://t.me/BKSBackstage" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div className="row">
        <div className="col-12">
          <div
            className="partners owl-carousel owl-loaded"
            style={{ display: "none" }}
          >
            <div className="owl-stage-outer">
              ...
              >
                <div
                  ...
                  style={{ width: 136.25, marginRight: 30 }}
                >
