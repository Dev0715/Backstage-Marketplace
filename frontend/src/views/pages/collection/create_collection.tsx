            ...
            <form action="#" className="sign__form sign__form--create">
              <div className="row">
                <div className="col-12">
                  <h4 className="sign__title">Upload Collection Image</h4>
                </div>
                ...
                <div className="col-12">
                  <div className="sign__file" style={{ height: "inherit" }}>
                    ...
                    >
                      Click here to upload large picture
                    </label>
                    <input
                      data-name="#file1"
                ...
                <div className="col-12 mt-3">
                  <div className="sign__file" style={{ height: "inherit" }}>
                    <label
                      ...
                      style={{ borderRadius: "10px" }}
                    >
                      Click here to upload small picture
                    </label>
                    <input
                      data-name="#file2"
                ...
                <div className="col-12" style={{ marginTop: "25px" }}>
                  <h4 className="sign__title">Collection details</h4>
                </div>
                ...
                <div className="col-12">
                  <div className="row row--grid">
                    ...
                    <div className="col-12 col-xl-6">
                      <div className="sign__group">
                        {/* <label className="sign__label" htmlFor="wallet_address">Owner wallet address</label> */}
                        <input
                          id="wallet_address"
                          type="text"
                          name="wallet_address"
                          className="sign__input"
                          placeholder="Onwer wallet address"
