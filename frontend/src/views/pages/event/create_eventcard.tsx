          ...
          <div className="col-12 col-xl-9">
            ...
            <div className="sign__form sign__form--create">
              <div className="row">
                <form action="#">
                  ...
                  <div className="col-12">
                    <div className="sign__file" style={{ height: "inherit" }}>
                      ...
                      >
                        {largeImagePreview
                          ? largeFile.name
                          : "Click here to upload large picture (Add image 1920px * 1280px)"}
                      </label>
                      <input
                        data-name="#file1"
                      ...
                      {validations.picture_large == "has-empty" ? (
                        ...
                        <span className="text-error">
                          Image Size should be 1900px * 1250px ~ 1950px * 1300px*
                        </span>
                      ) : (
                        ""
                      )}
                  ...
                  <div className="col-12 mt-3">
                    <div className="sign__file" style={{ height: "inherit" }}>
                      ...
                      >
                        {smallImagePreview
                          ? smallFile.name
                          : "Click here to upload small picture (Add image 260px * 300px)"}
                      </label>
                      <input
                        data-name="#file2"
                  ...
                  <div className="col-12">
                    <div className="row row--grid">
                      ...
                      <div className="col-12 col-xl-6">
                        <div className="sign__group">
                          {/* <label className="sign__label" htmlFor="owner_wallet">Owner wallet address</label> */}
                          <input
                            id="owner_wallet"
                            type="text"
                            name="owner_wallet"
                            className="sign__input"
                            placeholder="Owner wallet for BSC"
                      ...
                      <div className="col-12 col-xl-6">
                        <div className="sign__group">
                          {/* <label className="sign__label" htmlFor="owner_account">Owner wallet address</label> */}
                          <input
                            id="owner_account"
                            type="text"
                            name="owner_account"
                            className="sign__input"
                            placeholder="Owner account for NEAR"
                          ...
                          {validations.owner_account == "has-empty" ? (
                            <span className="text-error">
                              Owner account for NEAR is required*
                            </span>
                          ) : (
                            ""
                          )}
                      ...
                      <div className="col-12 col-xl-6">
                        <div className="sign__group">
                          {/* <label className="sign__label" htmlFor="fee_percentage">Payment fee percentage</label> */}
                          <input
                            id="fee_percentage"
                            type="text"
                            name="fee_percentage"
                            className="sign__input"
                            placeholder="Percentage of payment fee"
                          ...
                          {validations.fee_percentage == "has-empty" ? (
                            <span className="text-error">
                              Percentage of payment fee Required*
                            </span>
                          ) : (
                            ""
                          )}
                  ...
                  <div className="col-12" style={{ marginTop: "25px" }}>
                    <h4 className="sign__title">Add addons</h4>
                  </div>
                </form>
                ...
                {addons.map((addon: any, index: number) => (
                  <div className="col-12">
                    <div className="row row--grid sign__group addon-group">
                      <div className="padding-div order-short col-4 col-xl-2">
                        <input
                          type="text"
                          className="sign__input"
                          placeholder="Name"
                      ...
                      <div className="padding-div order-long col-12 col-xl-6">
                        <textarea
                          className="sign__textarea"
                          placeholder="Description"
                      ...
                      <div className="padding-div col-4 col-xl-2">
                        <input
                          type="text"
                          className="sign__input"
                          placeholder="Price"
                      ...
                      <div className="padding-div order-icon col-2 col-xl-1">
                        <div className="icon-btn">
                          <img src={addon.icon} alt="" height={46} />
                        </div>
                      </div>
                      <div className="padding-div col-2 col-xl-1">
                        <div
                ...
                <div className="col-12">
                  <div className="row row--grid sign__group">
                    <div className="padding-div order-short col-4 col-xl-2">
                      <input
                        type="text"
                        className="sign__input"
                    ...
                    <div className="padding-div order-icon col-2 col-xl-1">
                      <div className="icon-btn" onClick={select_Icon}>
                        <img
                          src={
                            addonIcon !== ""
                              ? addonIcon
                              : "/img/avatars/avatar0.jpg"
                          }
                          alt=""
                          height={46}
                        />
                    ...
                    <div className="padding-div col-2 col-xl-1">
                      <div className="sign__input add-btn" onClick={add_Addons}>
                        Add
                      </div>
                    </div>
                  </div>
