...
import { changeAvatar, getAllUserAvatars } from "../../../helper/user";
...
const Author = ({ wallet, setWallet }: any) => {
  ...
  const [isWalletValid, setWalletValid] = useState(true);

  const onChangeWallet = (e: any) => {
    setWallet(e.target.value);
    setWalletValid(_isWalletValid(e.target.value));
  };

  const _isWalletValid = (str: String) => {
    ...
    <div className="col-12 col-xl-3">
      <div className="author author--page">
        <div className="author__meta">
          ...
          >
            <S.Perfil top={0} width={150} height={150}>
              {imagePreview === "" ? (
                <React.Fragment>
          ...
          {isAvatarChanged ? (
            <div className="row" style={{ width: "100%" }}>
              <div className="col-12 col-xl-8">
                <button
                  className="sign__btn mt-0 btn-sm"
                  type="button"
                  onClick={saveAvatar}
                >
                  Save
          ...
          <p className="author__text">
            Please insert below your Binannce Smart Chain wallet address
          </p>
          ...
          {!isWalletValid && "Correct address Required*"}
          <div className="author__code">
            <input
              type="text"
              defaultValue=" https://bksbackstage.io"
              id="author-code"
            />
            <button type="button">
              <span>Copied</span>
          ...
          <div className="author__social">
            <a href={userInfo?.user?.facebook || "#"} target="_blank">
              {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href={userInfo?.user?.instagram || "#"} target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
