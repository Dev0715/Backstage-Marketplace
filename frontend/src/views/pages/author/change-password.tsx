          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6 col-lg-12 col-xl-6">
              <div className="sign__group">
                ...
                />
                {validations.old_password === "has-empty" ? (
                  <span className="text-error">Old password Required*</span>
                ) : (
                  ""
                )}
              </div>
            ...
            <div className="col-12 col-md-6 col-lg-12 col-xl-6">
              <div className="sign__group">
                ...
                {validations.new_password === "has-empty" ? (
                  <span className="text-error">New password Required*</span>
                ) : (
                  ""
                )}
              </div>
            ...
            <div className="col-12 col-md-6 col-lg-12 col-xl-6">
              <div className="sign__group">
                ...
                {validations.confirm_password === "not_matched" ? (
                  <span className="text-error">Password must be matched</span>
                ) : (
                  ""
                )}
              </div>
