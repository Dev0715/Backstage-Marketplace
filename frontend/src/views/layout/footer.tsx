        ...
        <div className="container">
            <div className="row">
               <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                    ...
                    BKS MarketPlace is a one-stop-shop for everyone in the industry, the BKS Marketplace lists ticket
sales, NFT drops, advertising opportunities &amp; more
                    </p> 
                    <br />
                    <br />
                     <img src="img/sss.png" alt="" />
                     <img src="img/sss_near.png" alt="" />
               ...
               <div className="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                        <div className="row">
                            {/* <div className="col-12">
                                <h6 className="footer__title">{"Explorer"}</h6>
                            </div> */}
                    ...
                    <div className="col-12">
                        <div className="footer__content">
                            <div className="footer__social">
                                ...
                                <a href="https://www.instagram.com/bksbackstage/?hl=en" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
