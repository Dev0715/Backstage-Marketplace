...
import { SendEmailDto } from './dtos/send_email.dto';
@Controller('api/auth')
...
export class AuthController {
  ...
  @Post('send_email')
  @ApiOkResponse({})
  async send_email(@Body() body: SendEmailDto): Promise<any> {
    await this.emailService.sendRegisterMail(body.email, body);
    console.log(body);
    return { success: true };
  }
